...
public:
    Application(std::string title,
                ...
                std::unique_ptr<IPaddleController> leftController = nullptr,
                std::unique_ptr<IPaddleController> rightController = nullptr);
    ~Application();
...
private:
    ...
    std::unique_ptr<IPaddleController> m_rightController;
